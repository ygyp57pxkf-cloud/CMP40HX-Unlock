...
2026-09-13本机主机端实测通过：Sunshine2026.516.143833，MikeTheTech VDD11.30.4.434，RainCandy616.56。VDD由Intel P630改绑40HX后，DXGI在40HX下出现1920×1080输出，Windows实际模式144Hz；Sunshine成功创建h264_nvenc与hevc_nvenc。物理屏仍启用。
...
- VDD `C:\VirtualDisplayDriver\vdd_settings.xml` 的 `gpu/friendlyname` 改成实际DXGI名称 `NVIDIA CMP 40HX (RainCandy Technology)`；保留1080p120，追加144Hz；只重载该VDD设备，不重置40HX。
